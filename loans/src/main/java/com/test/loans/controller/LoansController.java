...
import com.test.loans.repository.LoansRepository;
...
public class LoansController {
	...
	@PostMapping("/myLoans")
	public List<Loans> getLoansDetails(@RequestHeader("test-correlation-id") String correlationid,@RequestBody Customer customer) {
